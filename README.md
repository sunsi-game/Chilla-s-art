...
## Notes
저장소 용량 제한으로 인해 일부 외부 에셋(Fab 리소스, 고용량 텍스처, 일부 메쉬)은 제외했습니다.  
그 과정에서 에셋 참조 경로가 달라져 일부 블루프린트 또는 레벨에서 참조가 해제되어 보일 수 있습니다.

프로젝트의 핵심 구현 의도와 블루프린트 구조, 상호작용 흐름을 확인할 수 있도록 주요 로직은 유지했으며,  
실행 영상 및 설명 자료를 함께 첨부했습니다.
